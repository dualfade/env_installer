...
# git clone https://github.com/dualfade/env_installer.git
# cd env_installer ; python env_install.py

# definitions --
def splash_screen():
    print('\t\t-- ENV INSTALLATION --')
...
def start_local_config_setup():
    ...
    try:
        ...
        print('[i] ref: https://github.com/dualfade/env_installer/tree/master/config/editor/nvim')
